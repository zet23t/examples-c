...
"- When we store the result of a Dijkstra search, we can use it as a distance field\n"
"- Each cell in the map contains the distance to the source of the search\n"
"- This can be used to find the shortest path to any point on the map ...\n"
"- ... or to find the shortest point from any point on the map\n"
"- This is useful for AI behavior calculations:\n"
"   - Running Dijkstra once is (usually) cheaper than multiple A* searches\n"
"   - E.g. AI agents should react to an event, we can quickly find the nearest unit\n"
"- It can also be used to guide multiple agents to a target\n"
;
...
void page_6_onInit(TutorialPage *page) {}
void page_6_onEnter(TutorialPage *page) 
{
    subStep = 0;
}
void page_6_onLeave(TutorialPage *page) {}
void page_6_onUpdate(TutorialPage *page, float dt) 
{
    subStepTime += dt;
}
...
void page_6_onDraw(TutorialPage *page, float dt)
{
...
bool page_6_onNextSubstep(TutorialPage *page)
{
    subStepTime = 0.0f;
